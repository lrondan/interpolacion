...
opc1.add_separator()
opc1.add_command(label='Documentacion', command=Acerca)
...
tabla1 = ttk.Frame(tabla_control)
...
# --------------------------------------------
tabla2 = ttk.Frame(tabla_control)
...
# ------------------------------------------------
boton_salir = Button(ventana, text='Limpiar', command=Limpiar, bg='gray')
boton_salir.place(x=310, y=360, width=50, height=25)
boton_salir.config(cursor='heart')
# ------------------------------------------------
